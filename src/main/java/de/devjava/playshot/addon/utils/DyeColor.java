...
public enum DyeColor {
  WHITE(
    ...
    0, 15, Color.WHITE, Color.fromRGB(15790320)),
  ORANGE(
    
    1, 14, Color.fromRGB(14188339), Color.fromRGB(15435844)),
  MAGENTA(
    
    2, 13, Color.fromRGB(11685080), Color.fromRGB(12801229)),
  LIGHT_BLUE(
    
    3, 12, Color.fromRGB(6724056), Color.fromRGB(6719955)),
  YELLOW(
    
    4, 11, Color.fromRGB(15066419), Color.fromRGB(14602026)),
  LIME(
    
    5, 10, Color.fromRGB(8375321), Color.fromRGB(4312372)),
  PINK(
    
    6, 9, Color.fromRGB(15892389), Color.fromRGB(14188952)),
  GRAY(
    
    7, 8, Color.fromRGB(5000268), Color.fromRGB(4408131)),
  SILVER(
    
    8, 7, Color.fromRGB(10066329), Color.fromRGB(11250603)),
  CYAN(
    
    9, 6, Color.fromRGB(5013401), Color.fromRGB(2651799)),
  PURPLE(
    
    10, 5, Color.fromRGB(8339378), Color.fromRGB(8073150)),
  BLUE(
    
    11, 4, Color.fromRGB(3361970), Color.fromRGB(2437522)),
  BROWN(
    
    12, 3, Color.fromRGB(6704179), Color.fromRGB(5320730)),
  GREEN(
    
    13, 2, Color.fromRGB(6717235), Color.fromRGB(3887386)),
  RED(
    
    14, 1, Color.fromRGB(10040115), Color.fromRGB(11743532)),
  BLACK(
  ...
  static {
    ...
    int i;
    byte b;
    for (i = (arrayOfDyeColor = values()).length, b = 0; b < i; ) {
      DyeColor color = arrayOfDyeColor[b];
    ...
    BY_COLOR = (Map<Color, DyeColor>)byColor.build();
    BY_FIREWORK = (Map<Color, DyeColor>)byFirework.build();
  }
}
